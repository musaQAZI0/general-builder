    ...
    <footer className="bg-[#101c35] text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-[1fr_auto_auto] lg:px-10">
        ...
        <div className="text-sm">
          ...
          <a href={COMPANY.accounts.emailHref} className="mt-2 block break-all text-white/75 hover:text-[#d5ad55]">
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-2 border-t border-white/10 px-5 py-5 text-xs text-white/70 sm:flex-row sm:justify-between sm:px-8 lg:px-10">
        <span>Copyright {new Date().getFullYear()} Flint LTD</span>
